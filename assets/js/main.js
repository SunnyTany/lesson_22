...
function myPow(num1, num2, funcPrint) {
  let res = Math.pow(num1, num2);
  return funcPrint(num1, num2, res);
}
...
console.log('car 1 ', car.info()); // Chevrolet Lacetti, 2000cc, year 2010, used

car.used = 'new';

console.log('car 1 ', car.info()); // Chevrolet Lacetti, 2000cc, year 2019, new -- год изменен

car.used = 'used';

console.log('car 1 ', car.info()); // Chevrolet Lacetti, 2000cc, year 2019, new -- изменения не выполняются

console.log('car 2 ', car2.info()); // Infinite FX50 AWD, 5000cc, year 2019, new

console.log('car 3 ', car3.info()); // Infinite FX50 AWD, 5000cc, year 2019, new

car.used = 'used';

console.log(car3.info()); // Infinite FX50 AWD, 5000cc, year 2019, new -- изменения не выполняются
